      ...
      content: Column(
        ...
        children: [
          ...
          Expanded(
            ...
            //     // this variable is just a safe controller to avoid exception.
            //     if (snapshot.hasData) {
            ...
            //         //   first value is the played game
            //         ),
            //         StatsTile(
            //             heading: 'Win %',
            //             value: int.parse(results[2]),
            //         //   win percentage is the 3rd item
            //         ),
            //         StatsTile(
            //             heading: 'Current\nStreak',
            //             value: int.parse(results[3]),
            //         //   forth item is the streak
            //         ),
            //         StatsTile(
            //             heading: 'Max\nStreak',
            //             value: int.parse(results[4]),
            //         //     fifth item is the max streak
            //         ),
            //       ],
            //     );
            //   },
