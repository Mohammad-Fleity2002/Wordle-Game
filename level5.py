...
# Example usage:
json_file_path = [
    (r'C:\xampp\htdocs\wordle\Models\CAPITAL_DATA\CAPITALS.json', 20),
    (r'C:\xampp\htdocs\wordle\Models\CAPITAL_DATA\COMPANIES.json', 20),
    (r'C:\xampp\htdocs\wordle\Models\CAPITAL_DATA\CARS.json', 15),
    (r'C:\xampp\htdocs\wordle\Models\CAPITAL_DATA\COUNTRIES.json', 20),
    (r'C:\xampp\htdocs\wordle\Models\CAPITAL_DATA\FRUITS.json', 5),
    (r'C:\xampp\htdocs\wordle\Models\CAPITAL_DATA\VEGETABLES.json', 5),
    (r'C:\xampp\htdocs\wordle\Models\CAPITAL_DATA\MOVIES.json', 10),
...
merged_result = merge_results(result, 8)
